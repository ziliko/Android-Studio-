...
public class Stage2_SurfaceView extends Stage_Father{//父类只能一个,接口可以多个
    ...
    private void initValue(){
        ...
        mypower=2;//各关的自机初始蓝量
        bosslife_all=1500*(1+dif*dif);//各关的BOSS初始血量
                                ...
                                switch (dif){
                                    ...
                                    case 1://NORMAL
                                        if (bossdelay%600==0) { //单发弹(此处不改成%有奇效)
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1));//
                                        }
                                        if (bossdelay>=1800) { //弹射弹
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,45,5));//2方向扩散弹 + 5次弹射
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,135,5));
                                            bossdelay=0;
                                        }break;
                                    case 2://HARD
                                        ...
                                        if (bossdelay>=3600) { //弹射弹
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,30,5));//2方向扩散弹 + 2次弹射
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,60,5));
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,120,5));//2方向扩散弹 + 2次弹射
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,150,5));
                                            bossdelay=0;
                                        }break;
                            ...
                            case 1://第二阶段
                                ...
                                switch (dif){
                                    case 0://EASY
                                        if (bossdelay>=600) { //敌机子弹频度改这里
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1));//变子弹只需要改这里
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,10,bbt_kind1));//变子弹只需要改这里
                                            bossdelay=0;
                                        }break;
                                    case 1://NORMAL
                                        ...
                                        if (bossdelay>=1800) { //弹射弹
                                            for(int n=45;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,n,5));    //4方向扩散弹 + 5次弹射
                                            bossdelay=0;
                                        }break;
                                    case 2://HARD
                                        ...
                                        if (bossdelay>=3600) { //弹射弹
                                            for(int n=0;n<360;n+=30)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,6,bbt_kind1,0,n,5));    //12方向扩散弹 + 5次弹射
                                            bossdelay=0;
                                        }break;
                                    default:break;//0
                                }
                                ...
                                switch (dif){
                                    case 0://EASY
                                        if (bossdelay%600==0) { //敌机子弹频度改这里
                                            bbtList.add(new bossbullet(BOSS.bossX + BOSS.bossWidth / 2, BOSS.bossY + BOSS.bossHeight, screenWidth, screenHeight, 20, bbt_kind1));//变子弹只需要改这里
                                            bbtList.add(new bossbullet(BOSS.bossX + BOSS.bossWidth / 2, BOSS.bossY + BOSS.bossHeight, screenWidth, screenHeight, 10, bbt_kind1));//变子弹只需要改这里
                                            bbtList.add(new bossbullet(BOSS.bossX + BOSS.bossWidth / 2, BOSS.bossY + BOSS.bossHeight, screenWidth, screenHeight, 6, bbt_kind1));//变子弹只需要改这里
                                            //postInvalidate();
                                        }
                                        if(bossdelay>=3000) {
                                            bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20+k/10,bbt_kind1,0,2*k,8));    //随机速度方向弹+5次弹射
                                            bossdelay=0;
                                        }
                                        break;
                                    case 1://NORMAL
                                        //if(BOSS.bossX!=screenWidth/2-BOSS.bossWidth/2) BOSS.bossX=screenWidth/2-BOSS.bossWidth/2;//BOSS位置保持重置到屏幕中间() 或者变动?(图形无美感...?)
                                        ...
                                        if (bossdelay>=3000&&bossdelay%200==0) { //连续弹射弹
                                            ...
                                            if(time>66&&BOSS.bosslife<bosslife_all*2/3)
                                                for(int n=45;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,10,bbt_kind1,0,n,3));    //4方向扩散弹 + 5次弹射
                                            //强化阶段
                                            else if(time>33&&BOSS.bosslife<bosslife_all/3){
                                                if(m>50) for(int n=30;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,12,bbt_kind1,0,n,4));    //4方向扩散弹 + 5次弹射
                                                else for(int n=60;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,12,bbt_kind1,0,n,4));    //4方向扩散弹 + 5次弹射
                                            }
                                            //疯狂阶段
                                            else{
                                                if(m>66) for(int n=45;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,15,bbt_kind1,0,n,5));    //4方向扩散弹 + 5次弹射
                                                else if(m>33) for(int n=30;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,15,bbt_kind1,0,n,5));    //4方向扩散弹 + 5次弹射
                                                else for(int n=75;n<360;n+=90)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,15,bbt_kind1,0,n,5));    //4方向扩散弹 + 5次弹射
                                            }
                                        }
                                    ...
                                    case 2://HARD
                                        ...
                                        if (bossdelay>=5000&&bossdelay%200==0) { //弹射弹
                                            //0°起始
                                            if(time>66&&BOSS.bosslife>bosslife_all*2/3)
                                                for(int n=0;n<360;n+=30)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1,0,n,3));    //12方向扩散弹 + 5次弹射
                                            // 强化阶段 45°起始
                                            else if(time>33&&BOSS.bosslife>bosslife_all/3){
                                                for(int n=45;n<360;n+=30)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1,0,n,3));    //12方向扩散弹 + 5次弹射
                                            }
                                            //疯狂阶段 随机0° 45°起始
                                            else{
                                                if(m>50) for(int n=0;n<360;n+=30)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1,0,n,4));    //12方向扩散弹 + 5次弹射
                                                else for(int n=45;n<360;n+=30)  bbtList.add(new bossbullet(BOSS.bossX+BOSS.bossWidth/2,BOSS.bossY+BOSS.bossHeight,screenWidth,screenHeight,20,bbt_kind1,0,n,4));    //12方向扩散弹 + 5次弹射
                                            }
                                        }
    ...
    protected void section_change(){
        ...
        if(section==0){
            ...
            if(dif>0) BOSS.control=0;//N H 第三阶段静止
        }
        else time=45+15*dif;
        //清空屏幕上所有子弹
