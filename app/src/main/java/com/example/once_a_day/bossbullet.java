...
public class bossbullet {
    ...
    public bossbullet(int x, int y, int screenW, int screenH, double speed, Bitmap bitmap) {
    ...
    //初始化构造函数2  加入方式
    public bossbullet(int x, int y, int screenW, int screenH, double speed, Bitmap bitmap,int way) {
        basic_Init(x,y,screenW,screenH,speed,bitmap);
        move_way=way;
